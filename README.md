...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/iamRishabh07/Movie-Recommender-System/blob/master/requirements.txt) file with the command `pip install -r requirements.txt`
